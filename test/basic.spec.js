...
describe("Basic testing includes reading of different files", function () {
    ...
    it("Read a basic with a section and 2 simple keys and a comment", function () {
        ...
        expect(data['section1']).not.to.be.undefined;
    ...
    it("Read a basic with a section with multi level keys and single and multi line values", function () {
        ...
        expect(data['section1']['key2']['subkey3']).not.to.be.undefined;
        expect(data['section1']['key2']['subkey3']['subkey1']).to.equal('value6');

        // multi line parsing with second level
        expect(data['section1']['key3']).not.to.be.undefined;
        ...
        expect(data['section1']['key4']).not.to.be.undefined;
        expect(data['section1']['key4']['subkey1']).not.to.be.undefined;
    ...
    it("Read ini with array definitions", function () {
        ...
        // array in subkey
        expect(data['section1']['key3']).not.to.be.undefined;
        expect(data['section1']['key3']['subkey']).not.to.be.undefined;
...
//
//        expect(data['section']['invalid']).not.not.to.be.undefined;
//
//        expect(data['section']['invalid_multiline']).not.not.to.be.undefined;
//    });
//
